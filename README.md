...
| phoboslab/high_impact|https://github.com/phoboslab/high_impact|1048|A 2d game engine written in C|
...
| Vendicated/Vencord|https://github.com/Vendicated/Vencord|8928|The cutest Discord client mod|
| yeoman/yo|https://github.com/yeoman/yo|3842|CLI tool for running Yeoman generators|
| matter-labs/zksync-era|https://github.com/matter-labs/zksync-era|3089|zkSync era|
| 0age/create2crunch|https://github.com/0age/create2crunch|477|A Rust program for finding salts that create gas-efficient Ethereum addresses via CREATE2.|
...
<p>
    As from an ancestral oak<br/>Two empty ravens sound their clarion,<br/>Yell by yell, and croak by croak,<br/>When they scent the noonday smoke<br/>Of fresh human carrion:--<br/><br/>As two gibbering night-birds flit<br/>From their bowers of deadly yew<br/>Through the night to frighten it,<br/>When the moon is in a fit,<br/>And the stars are none, or few:--<br/><br/>As a shark and dog-fish wait<br/>Under an Atlantic isle,<br/>For the negro-ship, whose freight<br/>Is the theme of their debate,<br/>Wrinkling their red gills the while--<br/><br/>Are ye, two vultures sick for battle,<br/>Two scorpions under one wet stone,<br/>Two bloodless wolves whose dry throats rattle,<br/>Two crows perched on the murrained cattle,<br/>Two vipers tangled into one.<br/><br/>**
</p>
